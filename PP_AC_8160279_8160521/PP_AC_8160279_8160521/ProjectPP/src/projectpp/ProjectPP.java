...
public class ProjectPP {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("Add with success to " + container.getReference() + "? " + container.addItem(item, position, Color.silver));
        } catch (ContainerException e) {
            System.out.println(e.getMessage());
        }

        try {
            System.out.println("Add with success to " + container.getReference() + "? " + container.addItem(item2, position2, Color.silver));
        } catch (ContainerException e) {
            System.out.println(e.getMessage());
        }
        ...
        try {
            System.out.println("Add with success to " + container.getReference() + "? " + container.addItem(item3, position3, Color.silver));
        } catch (ContainerException e) {
            System.out.println(e.getMessage());
        } 
        ...
        try {
            System.out.println("Add with success to " + container2.getReference() + "? " + container2.addItem(item4, position2, Color.silver));
        } catch (ContainerException e) {
            System.out.println(e.getMessage());
        }
        ...
        try {
            System.out.println("Remove with success on " + container.getReference()+ "? " + container.removeItem(item3));
        } catch (ContainerException e) {
            System.out.println(e.getMessage());
        }
        ...
        try {
            System.out.println("Remove with success on " + container.getReference()+ "? " + container.removeItem(item4));
        } catch (ContainerException e) {
            System.out.println(e.getMessage());
        }
        ...
        try{
            System.out.println("Add with success in order? " + order.addContainer(container));
        ...
        try {
            System.out.println("Add with success in order? " + order.addContainer(container2));
        } catch (ContainerException | OrderException e) {
            System.out.println(e.getMessage());
        }        
